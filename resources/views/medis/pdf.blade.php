    ...
    <hr>
		...
		<table width="100%">
          ...
          <th style="text-align: center;">No</th>
					...
					<th>Poli</th>
					{{-- <th>Petugas</th> --}}
					<th style="text-align: lde">Biaya</th>
				</tr>
			</thead>
			<tbody>
				...
				<tbody>
					...
					<td style="text-align: right;">Rp. {{ number_format($rekam->biaya) }}</td>
				</tr>
				</tbody>
				@empty
				<tr>
				...
				<tr>
					...
					@foreach ($biaya as $b)
					<td style="text-align : right;" colspan="7">Rp. {{ number_format($b->total) }}</td>
					@endforeach
				</tr>
			</tbody>
		</table>
